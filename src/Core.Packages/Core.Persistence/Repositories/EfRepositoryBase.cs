...
namespace Core.Persistence.Repositories
{
        ...
        where TContext : DbContext
    {
        ...
        {
            SetEntityAsDeletedAsync(entity, permanent).GetAwaiter().GetResult();
            _context.SaveChanges();
        ...
        {
            SetEntityAsDeletedAsync(entities, permanent).GetAwaiter().GetResult();
            _context.SaveChanges();
        ...
        protected void CheckHasEntityHaveOneToOneRelation(TEntity entity)
        {
            ...
            {
                throw new InvalidOperationException("Entity has one-to-one relationship. Soft delte causes problems if you try to create entry again by same foreign key.");
            }
        }
